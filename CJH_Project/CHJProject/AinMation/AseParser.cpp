...
int AseParser::GetData(string FindStr, void* pData, int iType)
{
	int iLine = -1;
	char szTemp[255] = { 0, };
...
int AseParser::FindString(string szFind)
{
...
bool AseParser::GetAnimInfo()
{
	...
	if (GetData("CONTROL_SCALE_TRACK "))
	{
