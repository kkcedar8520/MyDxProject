...
bool Sample::Init()
{
	...
	m_LightObj.CreateLightObj(m_pd3dDevice, m_pImmediateContext, D3DXVECTOR3(100, 200, 100), D3DXVECTOR3(0, 0, 0), m_pMainCamera->m_vPos, m_pMainCamera->m_vLookup);
...
bool Sample::Frame()
{
	...
	m_LightObj.UpdateCamera(m_pMainCamera->m_vPos, m_pMainCamera->m_vLookup);
	m_LightObj.Frame();
