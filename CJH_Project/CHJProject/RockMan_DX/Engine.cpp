...
//
	//
	JDX::ApplyBS(GetContext(), JDX::JH_DxState::g_pAlpahBlend);
	JDX::ApplySS(GetContext(), JDX::JH_DxState::g_pSamplerState);
	JDX::ApplyRS(GetContext(), JDX::JH_DxState::g_pRSSold);
	JDX::ApplyDSS(GetContext(), JDX::JH_DxState::g_pDSS);
	return true;
}
bool Engine::Frame()
{
